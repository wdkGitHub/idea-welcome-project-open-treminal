 ...
 * <p>
 */
public class SourcetreeAppProject extends AnAction {
    private static final Logger logger = Logger.getInstance(SourcetreeAppProject.class);
    ...
    public void actionPerformed(@NotNull AnActionEvent event) {
        ...
        if (virtualFile.getParent() != null) {
            ...
            ExecuteCommand.execute(path, CommandOrApp.Command.SourceTree_Command);
        } else {
